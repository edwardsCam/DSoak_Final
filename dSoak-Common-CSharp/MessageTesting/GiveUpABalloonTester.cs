...
namespace MessageTesting
{
    ...
    public class GiveUpABalloonTester
    {
        ...
        [TestMethod]
        public void GiveUpABalloon_CheckEverything()
        {
            ...
            GiveUpABalloon msg2 = new GiveUpABalloon() { GameId = 11, TargetProcessId = 12, ThiefId = 13 };
            ...
            Assert.IsTrue(msg3 is GiveUpABalloon);
            GiveUpABalloon msg4 = msg3 as GiveUpABalloon;
