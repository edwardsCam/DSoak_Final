...
namespace MessageTesting
{
    ...
    public class StealingTester
    {
        ...
        [TestMethod]
        public void Stealing_CheckEverything()
        {
            Stealing msg1 = new Stealing();
            ...
            Stealing msg2 = new Stealing() { GameId=11, TargetProcessId=12, ThiefId=13};
            ...
            Assert.IsTrue(msg3 is Stealing);
            Stealing msg4 = msg3 as Stealing;
