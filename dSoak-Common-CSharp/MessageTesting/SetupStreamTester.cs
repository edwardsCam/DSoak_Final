...
namespace MessageTesting
{
    ...
    public class SetupStreamTester
    {
        ...
        [TestMethod]
        public void SetupStream_CheckEverything()
        {
            ...
            SetupStream msg2 = new SetupStream() { ConvId = msg1.ConvId };
            ...
            Assert.IsTrue(msg3 is SetupStream);
            SetupStream msg4 = msg3 as SetupStream;
