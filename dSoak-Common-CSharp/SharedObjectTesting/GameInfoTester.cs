...
namespace SharedObjectTesting
{
    ...
    public class GameInfoTester
    {
        ...
        public void GameInfo_TestEverything()
        {
            ...
            Assert.AreEqual(ep1, g1.FlightManagerEP);
            Assert.AreEqual(10, g1.GameId);
            Assert.AreEqual(5, g1.MaxPlayers);
            Assert.AreEqual(GameInfo.StatusCode.Avaliable, g1.Status);
